...
- Conserva el “aura verde” en las fotografías de contenido: una veladura cromática verde bosque dentro de la imagen, apoyada por una sombra ambiental suave. Puede ser fuerte en bloques inmersivos como oración y sutil en galerías, paneles y predicaciones. Aplícala desde el contenedor, no a logos ni iconos, y protege la legibilidad, los tonos de piel y el punto focal.
